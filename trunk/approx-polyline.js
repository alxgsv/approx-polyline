ApproxPolyline = function(gmap, lls, f, range, points){
	...
	this.transform_zoom = function(point){
		/* Zo_Om */
		point.x *= this.zoom;
		point.y *= this.zoom;
		return point;
	}
	this.transform_turn = function(point){
		/* Turn */
